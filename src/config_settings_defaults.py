...
def generate_default_config():
    ...
    RestDownconf = RestDownRotConfig(
        rest_data=False,
    ...
    synthsconf = SynthDataConfig(
        make_syn_data=False, engine_path="/path/to/GF_stores", store_id="global_2s"
    )

    gainfconf = GainfactorsConfig(
